DROP DATABASE IF EXISTS guns_cloud_system;
CREATE DATABASE IF NOT EXISTS guns_cloud_system DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

USE guns_cloud_system;
...
/*
 ...
 Source Schema         : guns_cloud_system

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 29/05/2019 14:40:40
*/
...
CREATE TABLE `sys_app` (
  ...
  `app_ip` varchar(255) DEFAULT NULL COMMENT '应用的ip地址',
  `app_url` varchar(255) DEFAULT NULL COMMENT 'app网站地址',
  `app_icon` varchar(255) DEFAULT NULL COMMENT '图标地址',
  `app_dict_code` varchar(50) DEFAULT NULL COMMENT '字典编码',
  `description` varchar(1000) DEFAULT NULL COMMENT '应用描述',
  `order_no` int(11) DEFAULT NULL COMMENT '排序',
  `status` int(11) DEFAULT NULL COMMENT '权限状态(1:启用,2:禁用)',
  `platform_code` char(32) DEFAULT '' COMMENT '平台类型',
  `create_user` char(32) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_user` char(32) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `del_flag` char(1) DEFAULT 'N' COMMENT '删除标记(Y:已删除 N:未删除)',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_app` VALUES ('1', '系统管理', 'guns', 'http://172.23.5.1/system/#/wel/index', '', '123', 'support_class', '系统管理平台', 10, 1, '123', '', NULL, 'b9a35eff2e8f47b58f159e02fd3c9ff4', '2019-05-14 13:53:14', 'N');
COMMIT;
...
CREATE TABLE `sys_resource` (
  ...
  `modular_code` varchar(100) DEFAULT NULL COMMENT '资源模块编码',
  `modular_name` varchar(100) DEFAULT NULL COMMENT '资源模块名称',
  ...
  `menu_flag` char(1) DEFAULT NULL COMMENT '是否是方法',
  `required_login_flag` char(1) DEFAULT NULL COMMENT '是否需要登录',
  `required_permission_flag` char(1) DEFAULT NULL COMMENT '是否需要鉴权标识',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `ip_address` varchar(255) DEFAULT NULL COMMENT '资源初始化的服务器地址',
...
CREATE TABLE `sys_role_resource` (
  ...
  `resource_id` varchar(300) NOT NULL COMMENT '资源id',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, '1124606971782160385', 'admin', 'f8f3d70c613f55e5276b617eb2fba5e2', 'q6taw', 'stylefeng', '2018-11-16 00:00:00', 'M', 'sn93@qq.com', '18200000000', '1', 27, 'ENABLE', '2016-01-29 08:49:53', NULL, '2019-05-04 17:29:31', 24, 25);
COMMIT;
