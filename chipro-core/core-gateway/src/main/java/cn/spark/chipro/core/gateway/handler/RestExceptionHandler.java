...
public class RestExceptionHandler extends DefaultErrorWebExceptionHandler {
    public RestExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ErrorProperties errorProperties, ApplicationContext applicationContext) {
    ...
    protected Map<String, Object> getErrorAttributes(ServerRequest request, boolean includeStackTrace) {
        ...
        if (error instanceof CoreException) {
            ...
            return response(coreException.getCode(), coreException.getMessage());
        }
