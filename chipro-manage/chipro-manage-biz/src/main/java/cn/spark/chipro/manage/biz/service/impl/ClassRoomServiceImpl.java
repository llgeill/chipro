...
public class ClassRoomServiceImpl extends ServiceImpl<ClassRoomMapper, ClassRoom> implements ClassRoomService {
    ...
    public PageInfo findPageBySpec(ClassRoomParam param){
        ...
        if(param!=null){
            if(StringUtil.isNotEmpty(param.getSchoolId())){
                objectQueryWrapper.in("SCHOOL_ID",param.getSchoolId());
            }
        }
        ...
        classRoomList.forEach(classRoom -> {
            ...
            classUserParam.setClassRoomId(classRoom.getClassId());
            List<ClassUser> student = classUserService.findStudentByCLassID(classUserParam);
